...
class CRF(nn.Module):
    ...
    def _calculate_PZ(self, feats, mask):
        ...
        # print("calculate_PZ1:",feats.shape)
        # print("calculate_PZ2:",self.tagset_size)
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        partition_history = partition_history.transpose(1,0)
        partition_history = partition_history.contiguous()
