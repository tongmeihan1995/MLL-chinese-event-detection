...
class BiLSTM(nn.Module):
    ...
    # def forward(self, gaz_list, word_inputs, biword_inputs, word_seq_lengths,  char_inputs, char_seq_lengths, char_seq_recover, mask, gaz_list_ner, word_inputs_ner, biword_inputs_ner, word_seq_lengths_ner,  char_inputs_ner, char_seq_lengths_ner, char_seq_recover_ner, mask_ner):
    ...
    #     # outs_ner = self.get_output_score_ner(gaz_list_ner,  word_inputs_ner, biword_inputs_ner, word_seq_lengths_ner, char_inputs_ner, char_seq_lengths_ner, char_seq_recover_ner)
    #     # outs_ner = outs_ner.view(total_word, -1)
    #     # _, tag_seq_ner  = torch.max(outs_ner, 1)
    #     # tag_seq_ner = tag_seq_ner.view(batch_size, seq_len)
    #     # ## filter padded position with zero
    #     # decode_seq_ner = mask_ner.long() * tag_seq_ner
    #     return decode_seq#,decode_seq_ner
